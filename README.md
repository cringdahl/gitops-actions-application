...
This repository works in concert with [this manifest repository](https://github.com/cringdahl/gitops-actions-manifests)
...
application into a [container image hosted on quay.io](https://quay.io/repository/cringdahl/gitops-and-actions?tab=tags).
Once the build is complete, it will trigger a [workflow](https://github.com/cringdahl/gitops-actions-manifests/blob/main/.github/workflows/update-container-image.yaml)
that creates a PR in the manifest repository that updates the [deployment manifests](https://github.com/cringdahl/gitops-actions-manifests/blob/main/helm/values.yaml#L4)
...
These variables are used in the [CI workflow](https://github.com/cringdahl/gitops-actions-application/blob/main/.github/workflows/build-container-image.yaml).
...
1. Set **Repository access** to your fork of the [manifest repository](https://github.com/cringdahl/gitops-actions-manifests).
